...
<div class="hniois-table">
    <form action="providers/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'providers/add')}">
                ...
                <c:if test="${fn:contains(QX,'providers/delete')}">
                ...
                <c:if test="${fn:contains(QX,'providers/export')}">
                    <a id="hniois-export" onclick="doExport('providers/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'providers/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
               ...
               // {field:'p_id', width:100, title: '基地ID'},
                ...
                // {field:'p_register', title: '统一信用号', width:180, align:'center'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'providers/update')}"=="true"){
    ...
    function toEdit(p_id,code){
        ...
        layer.open({
            ...
            content: "providers/toEdit.do?p_id="+p_id+"&code="+code,
            area: ['750px', '80%']
        });
    }
    ...
    //单个删除
    function doDelete(p_id){
        $.ajax({
            url: 'providers/delete.do',
            data: {
                p_id:p_id
            },
            type: "post",
    ...
    function toProvidersImgs(p_id){
        ...
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "providers/toEditImgs.do?p_id="+p_id,
            area: ['650px', '80%']
        });
    }
