    ...
    <form action="report/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <a id="hniois-export" onclick="doExport('report/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                    <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="report_num" placeholder="报告编号.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="report_name" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">检测产品</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="office" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                // {field:'rid', title: '基地编号',align:'center'},
                // {field:'farm_id', title: '基地编号',align:'center'},
                // {field:'crop_id', title: '基地编号',align:'center'},
                {field:'report_num', title: '报告编号',align:'center',width: 150},
                {field:'report_name',  title: '报告名称',align:'center'},
                {field:'crop',  title: '产品名称',align:'center'},
                ...
                {field:'office',  title: '检测机构',align:'center',width: 220},
                {field:'ck_time',  title: '检测时间',align:'center'},
                {field:'report_img', title: '报告图片',align:'center',templet:function(d){
                        //检测报告多张图片，默认显示第一张
                        var img="static/images/icon/school.png";
                        if(d.report_img){
                            img = d.report_img.split(",")[0];
                        }
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "report/toEdit.do?rid="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
    ...
    function toChangeReportImgs(id){
        ...
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "report/toEditImgs.do?rid="+id,
            area: ['650px', '80%']
        });
    }
</script>
