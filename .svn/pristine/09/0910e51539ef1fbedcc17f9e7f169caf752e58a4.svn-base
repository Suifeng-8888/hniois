...
<div class="hniois-table">
    <form action="butcher/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <a id="hniois-export" onclick="doExport('butcher/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="but_name" placeholder="屠宰家畜.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="but_batch" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="but_time"  class="layui-input" id="test1" placeholder="yyyy-MM-dd"
                               autocomplete="off"   >
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="but_person" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="detail">查看</a>
        ...
        <a class="layui-btn layui-btn-xs" lay-event="drug">屠宰检疫</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'but_batch', title: '屠宰批次',align:'center'},
                {field:'but_name', title: '屠宰品种',align:'center'},
                {field:'but_nums',  title: '屠宰数量',edit:'text',align:'center'},
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "butcher/toEdit.do?but_id="+id+"&code="+code,
            area: ['750px', '80%']
        });
    }
    ...
    function doDeletes(){
        ...
        for(var i=0;i<data.length;i++){
            ids.push(data[i].but_id);
        }
        layui.layer.confirm('确认删除', function(index){
            $.ajax({
                url: 'butcher/deletes.do',
                data: {
                    data:ids.toString()
                },
                type: "post",
    ...
    function fillData(id){
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "butcher/detail.do?but_id="+id,
            area: ['1200px', '80%']
        })
    }
