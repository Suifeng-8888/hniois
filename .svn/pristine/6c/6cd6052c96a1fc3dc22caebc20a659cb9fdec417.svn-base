...
<form class="layui-form layui-form-pane" action="" >
    <input type="hidden" name="batch_id" id="key" value="${batch_material.batch_id}">
...
<%--检测报告图片信息--%>
<div style="display: none" id="bat_img">${batch_material.bat_img}</div>
</body>
