...
public class OrderDaoImpl implements OrderDao {
    ...
    public List<Order> findList(Order e) throws Exception {
        return (List<Order> )dao.findList(mapper+".findList",e);
    }
    ...
    public List<OrderCount> countWeek(Order e) throws Exception {
        return (List<OrderCount>)dao.findList(mapper+".countWeek",e);
    }

    @Override
    public List<OrderCount> countMonth(Order e) throws Exception {
        return (List<OrderCount>)dao.findList(mapper+".countMonth",e);
    }
    ...
    public Page findCropPage(Order e) throws Exception {
        return dao.findPage(mapper+".findCropPage",mapper+".findCropCount",e);
    }
    ...
    public Page findSalePage(Order e) throws Exception {
        return dao.findPage(mapper+".findSalePage",mapper+".findSaleCount",e);
    }
}
