...
<form class="layui-form layui-form-pane" action="" >
    ...
    <div class="layui-form-item">
        <div id="download" class="layui-input-inline" url="${provide.provide_img}" onclick="fileDownload(this)"
             title="点击下载">
            <img id="provide_img" name="provide_img" class="layui-circle" src="${provide.provide_img}"
        ...
        upload.render({
            ...
            ,choose: function(obj){
                ...
                obj.preview(function(index, file, result){
                    $('#provide_img').attr('src', result); //图片链接（base64）
                });
            }
            ,done: function(res){
                if(res.state=="ok"){
