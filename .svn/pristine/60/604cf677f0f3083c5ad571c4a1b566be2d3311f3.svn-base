...
<div class="hniois-table">
    <form action="soil/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <a id="hniois-export" onclick="doExport('soil/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_number" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'soil/update')}">
...
<script>
        ...
        data_table = table.render({
            ...
            cols: [[
              ...
              //  {field:'id',  title:'ID',align:"center"},
               ...
               // {field:'crop_id', title: '作物ID',align:"center"},
                {field:'s_number',  title:'土地编号',align:"center"},
                {field:'area', title: '土地面积',edit:'text',align:"center"},
                {field:'crop',  title: '作物名称',align:"center"},
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "soil/toEdit.do?id="+id+"&code="+code,
            area: ['750px', '80%']
        });
    }
