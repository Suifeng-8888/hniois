...
<%--<div class="container demo-3" id="container">--%>
<div id="container">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <div class="kit-login-box">
                ...
                <footer>
                    <p>HNIOIS © <a href="http://www.hniois.com" style="color:white; font-size:18px;" target="_blank">www.baidu.com</a></p>
                </footer>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#container").addClass("container demo-" + num);
