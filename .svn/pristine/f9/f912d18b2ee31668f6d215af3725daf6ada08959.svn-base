...
<form class="layui-form layui-form-pane" action="" >
    ...
    <%--</div>--%>
        ...
        <div class="layui-input-block" >
            <select name="bz" id="bz" lay-verify="required" lay-search="">
    ...
    <%--<div class="layui-form-item">--%>
        ...
        <div class="layui-input-block">
            <input name="dept_name" style="height:36px;width:350px" type="text" autocomplete="off"
                   id="dept_select"    lay-verify="required" value="${user.dept_name}">
