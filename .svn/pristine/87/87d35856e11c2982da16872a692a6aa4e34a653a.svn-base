            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="dept_name" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <%--<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="role_id" id="hniois-role-select" autocomplete="off" lay-search="" class="hniois-search-data">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'user_id', title:'账号ID',width:120, align:'center'},
                {field:'bz', title: '账号类型', align:'center',width:150},
                {field:'username', title: '用户名',width:150, align:'center'},
                {field:'dept_name', title: '所属机构名称',width:220, align:'center'},
                {field:'role_name', title: '角色',width:150, align:'center'},
                ...
                {field:'user_img', title: '头像',width:100, align:'center',templet:function(d){
