...
<div class="hniois-table">
    <form action="poison/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'poison/add')}">
                ...
                <c:if test="${fn:contains(QX,'poison/delete')}">
                ...
                <a id="hniois-export" onclick="doExport('poison/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                    <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="crop" placeholder="作物名称.." />
        ...
        <div class="hniois-search-mored layui-anim layui-anim-upbit">
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    <label class="layui-form-label">农药名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="pname" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'poison/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
              //  {field:'pid', title: '序号',title: '打药ID',align:'center'},
              //  {field:'farm_id', title: '序号',title: '农场编号',align:'center'},
              //  {field:'crop_id',  title: '作物ID',edit:'text',align:'center'},
              //  {field:'buy_id',  title: '采购ID',edit:'text',align:'center'},
                {field:'crop',  title: '打药作物',align:'center'},
                {field:'pname',  title: '农药名称',align:'center'},
                {field:'p_time',  title: '打药时间',align:'center'},
                {field:'person',  title: '打药人',align:'center'},
                {field:'p_img',  title: '图片',align:'center',templet:function(d){
                        //打药多张图片，默认显示第一张
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "poison/toEdit.do?pid="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
    ...
    function toChangePosionImgs(id){
        ...
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "poison/toEditImgs.do?pid="+id,
            area: ['650px', '80%']
        });
    }
