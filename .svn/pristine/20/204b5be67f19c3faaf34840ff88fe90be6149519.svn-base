...
<form class="layui-form layui-form-pane" action="" >
    ...
    <input type="hidden" name="sup_id" id="sup_id" value="${tData.sup_id}">
    <input type="hidden" name="farm_id"  value="${tData.farm_id}">
    <div class="layui-form-item">

        <label class="layui-form-label">所用材料<span style="color: #FF5722">*</span></label>
        <div class="layui-input-block">
            <input name="data_name" class="layui-input" type="text" autocomplete="off"
                 lay-verify="required" value="${tData.data_name}">
        ...
        <div class="layui-input-block">
            <input name="mat_sup"  type="text" autocomplete="off"  style="height:36px;width:400px"
                   id="supply"   lay-verify="required" value="${tData.mat_sup}">
            <span data-method="notice" id="chose"  class="layui-btn">选择供应商</span>
        </div>
        <%-- </div>--%>
        <%--<div class="layui-form-item">--%>
