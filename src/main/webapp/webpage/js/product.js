...
$(function() {
    ...
    var param2 = main.getUrlString("param2");
    var param3 = main.getUrlString("param3");
    //分页查询
    findPage(param,param2,param3);
    //绑定按钮事件
    searchBtnFn();
    //绑定事件:返回顶部
    main.backTopFn();
...
var page_count = 0;
//分页查询
function findPage(param,param2,param3,page,limit){
    //初始化查询框内容
    $(".search-mod .search-input").val(param3);
    //请求数据
    $.ajax({
        type: "post",
        dataType: 'JSON',
