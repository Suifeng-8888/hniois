    ...
    <form action="Buy/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'buy/add')}">
                ...
                <c:if test="${fn:contains(QX,'buy/delete')}">
                ...
                <a id="hniois-export" onclick="doExport('buy/doExports')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                    <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="b_name" placeholder="搜索物品名.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="b_provider" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'buy/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'b_provider',  title: '供应商',width:250,align:'center'},
                {field:'b_name', title: '物品名',width:200,align:'center'},
                {field:'b_category', title: '类别',align:'center',width:100,templet:function(d) {
                ...
                {field:'b_spec', title: '物品规格',width:150,align:'center'},
                {field:'b_price', title: '单价(¥)',width:100,align:'center'},
                {field:'b_number', title: '采购数量',width:100,align:'center'},
                {field:'b_time', title: '采购时间',width:150,align:'center'},
                {field:'b_buyer', title: '采购人',width:150,align:'center'},
                {field:'total_cost', title: '总花费(￥)',width:100,align:'center'},
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            offset: "10px",
            maxmin: true,
            content: "buy/toEdit.do?id="+id+"&code="+code,
            area: ['700px', '80%']
        });
    }
