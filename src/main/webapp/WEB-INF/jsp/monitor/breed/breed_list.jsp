        ...
        <div class="hniois-search-mored layui-anim layui-anim-upbit">
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    <label class="layui-form-label">所喂饲料</label>
                    <div class="layui-input-block">
                        <input type="text" name="feed_name" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="begin_time" autocomplete="off" class="layui-input hniois-search-data"
                               id="test1" placeholder="yyyy-MM-dd"  class="layui-input" >
                    </div>
                </div>
...
<script type="text/html" id="editBar">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-success" lay-event="detail">养殖详情</a>
        <a class="layui-btn layui-btn-xs" lay-event="drug">疫苗记录</a>
...
<script>
        ...
        data_table = table.render({
            ...
            cols: [[
               ...
               // {field:'breed_id', title: '养殖编号',align:'center'},
                {field:'b_batch', title: '养殖批次',align:'center'},
                {field:'breed_name', title: '家畜名称',align:'center'},
                {field:'b_nums', title: '批次数量',align:'center'},
              //  {field:'farm_id',  title: '农场编号',edit:'text',align:'center'},
                {field:'feed_name',  title: '所喂饲料',edit:'text',align:'center'},
                {field:'breeder',  title: '喂养人',edit:'text',align:'center'},
                ...
                {fixed: 'right', width: 350, align:'center', toolbar: '#editBar'}
            ]],
    ...
    function addData(id){
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "breed/addPig.do?breed_id="+id,
            area: ['1200px', '80%']
        })
    }
    //防疫疫苗情况
