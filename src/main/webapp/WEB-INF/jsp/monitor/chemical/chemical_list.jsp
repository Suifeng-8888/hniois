...
<div class="hniois-table">
    <form action="chemical/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'chemical/add')}">
                ...
                <c:if test="${fn:contains(QX,'chemical/delete')}">
                ...
                <c:if test="${fn:contains(QX,'chemical/export')}">
                    <a id="hniois-export" onclick="doExport('chemical/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                        <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
                </c:if>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="crop" placeholder="搜索作物名.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="cname" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">施肥负责人</label>
                    <div class="layui-input-block">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'chemical/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            elem: '#table',
            url:'chemical/list.do',
            limits:[10],
            cols: [[
                {type:'checkbox'},
               // {field:'id',  title: '序号'},
                {field:'crop', title: '施肥作物', align:'center'},
                {field:'cname', title: '化肥名称', align:'center'},
                {field:'c_time', title: '施肥时间', align:'center'},
                {field:'method', title: '施肥方法', align:'center',templet:function(d) {
                        var str = d.method;
                        if (str == "0") {
                            str= "机器";
                        } else if (str == "1") {
                ...
                {field:'person', title: '施肥负责人', align:'center'},
                {field:'c_img', title: '图片', align:'center',templet:function(d){
                        //打药多张图片，默认显示第一张
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'chemical/update')}"=="true"){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "chemical/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
    ...
    //施肥照片上传
    function toChangeChemicalImgs(id){
        var layer = layui.layer ;
        layer.open({
            title : "施肥图片",
            type: 2,
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "chemical/toEditImgs.do?id="+id,
            area: ['650px', '80%']
        });
    }
</script>
