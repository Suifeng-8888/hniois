...
<div >
    <form class="layui-form layui-form-pane" action="" >
        ...
        <div class="layui-input-block">
            <input name="name" class="layui-input" readonly="readonly" type="text" autocomplete="off" value="${outfit.name}">
        </div>
        <label class="layui-form-label">监管机构代码:</label>
        <div class="layui-input-block">
            <input name="number" readonly="readonly" class="layui-input" type="text" autocomplete="off" value="${outfit.number}">
        </div>
        <label class="layui-form-label">监管机构级别:</label>
        <div class="layui-input-block">
            <select name="grade" id="tp" lay-verify="required"  autocomplete="off"  lay-search="" disabled="disabled">
        ...
        <div class="layui-input-block">
            <div class="layui-input-inline" >
                <select name="p_city" id="cty" disabled="disabled">
                    <option value="">请选择市</option>
                    <option value="平顶山市" selected="">平顶山市</option>
                </select>
            </div>
            <div class="layui-input-inline" >
                <select name="area"  id="ops" disabled="disabled">
                </select>
            </div>
        </div>
