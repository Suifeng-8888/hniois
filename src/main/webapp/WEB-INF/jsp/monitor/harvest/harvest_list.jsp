        ...
        <div class="hniois-search-mored layui-anim layui-anim-upbit">
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    <label class="layui-form-label">采摘批次</label>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">出货情况</label>
                    <div class="layui-input-block">
                        <select name="state" id="sta"  lay-search="">
                            <option value="">请选择</option>
                            <option value="0">待出货</option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
              //  {field:'hid', title: '采摘ID',align:'center'},
              //  {field:'farm_id', title: '农场ID',align:'center'},
              //  {field:'crop_id',  title: '作物ID',edit:'text',align:'center'},
                {field:'crop',  title: '作物名称',edit:'text',align:'center'},
                {field:'batch',  title: '采摘批次',edit:'text',align:'center', width: 200},
                {field:'h_time',  title: '采摘时间',edit:'text',align:'center'},
                {field:'person',  title: '负责人',edit:'text',align:'center'},
                {field:'state',  title: '出货情况',align:'center',templet:function(d){
                    var str=d.state;
                    if(str=="0"){
                        str="<span style='color:blue'>待出货</span>"
                    }
                    if(str=="1"){
                            str="<span style='color:darkgreen'>已出货</span>"
                        }
                    if(str=="2"){
                        str="<span style='color:red'>废弃</span>"
                    }
                        return str;
                    }},
                {field:'h_img',  title: '图片',align:'center',templet:function(d){
                        //打药多张图片，默认显示第一张
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "pick/toEdit.do?hid="+id+"&code="+code,
            area: ['750px', '80%']
        });
    }
    ...
    //采摘照片上传
    function toChangeHarvsetImgs(id){
        var layer = layui.layer ;
        layer.open({
            title : "采摘图片",
            type: 2,
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "pick/toEditImgs.do?hid="+id,
            area: ['650px', '80%']
        });
    }
