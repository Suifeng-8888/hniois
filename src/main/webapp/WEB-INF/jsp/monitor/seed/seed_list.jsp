            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="s_name" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
             ...
             //   {field:'crop_id',  title: '作物ID'},
             //   {field:'farm_id',  title: '基地ID'},
             //   {field:'buy_id',  title: '采购ID'},
                {field:'crop',  title: '作物名称', align:'center'},
                {field:'s_name',  title: '种子名称', align:'center'},
                {field:'s_time',  title: '播种时间', align:'center'},
                {field:'tool',  title: '播种方式', align:'center',templet:function(d) {
                        var str = d.tool;
                        if (str == "0") {
                            str="机器";
                        } else if (str == "1") {
                ...
                {field:'s_img',  title: '播种图片', align:'center',templet:function(d) {
                        //检测报告多张图片，默认显示第一张
                ...
                {field:'people',  title: '播种负责人', align:'center'},
                // {field:'bz',  title: '备注'},
