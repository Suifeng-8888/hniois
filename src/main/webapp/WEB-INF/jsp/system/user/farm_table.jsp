...
<script>
        ...
        data_table = table.render({
            ...
            cols: [[
               ...
               // {field:'p_id', width:100, title: '基地ID'},
                {field:'p_name',  title: '基地名称',width: 200},
                {field:'p_industry', title: '所属行业'},
                {field:'p_person', title: '基地法人'},
                {field:'p_address',title: '详细地址', width:200}
            ]],
    ...
    function sendMsg(){
        ...
        if (d.data.length === 0) {
            layui.layer.msg('请选择生产基地');
            return;
        }
        if (d.data.length > 1) {
            layui.layer.msg('只能选择一个');
            return;
        }
        var data = d.data,
            ids=[],
        ...
        parent.$('#dept_select').val(names.toString());
        parent.$('#dId').val(ids.toString());
