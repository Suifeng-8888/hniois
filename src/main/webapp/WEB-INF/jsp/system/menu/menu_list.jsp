...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'menu_id',  title:'菜单ID',width:120,align:"center"},
                {field:'menu_name', title: '菜单名称',width:120,align:"center"},
                {field:'menu_url',  title: '菜单地址',align:"center"},
                {field:'menu_icon', title: '菜单图标',align:"center"},
