    ...
    <form action="order/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <a id="hniois-export" onclick="doExport('order/doExports')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                    <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="order_num" placeholder="订单号.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="crop" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="recever" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="drive">运输详情</a>
    <c:if test="${fn:contains(QX,'order/delete')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
               // {field:'order_id',  title:'农场编号',align:"center"},
               // {field:'farm_id',  title:'农场编号',align:"center"},
               // {field:'crop_id',  title:'农场编号',align:"center"},
               // {field:'sale_id',  title:'农场编号',align:"center"},
                {field:'order_num',  title:'订单编号',align:"center",width:250},
                {field:'crop', title: '产品名称',align:"center",width:100},
                {field:'o_numbers', title: '订单数量',align:"center",width:100},
                {field:'o_price', title: '单价(¥)',align:"center",width:100},
                {field:'sender', title: '发货人',align:"center",width:100},
                {field:'send_time', title: '发货时间',align:"center",width:150},
                {field:'send_address', title: '发货地址',align:"center",width:300},
                {field:'sale_name', title: '销售商',align:"center",width:250},
                {field:'recever', title: '收货人',align:"center",width:100},
                {field:'end_address',  title: '收货地址',align:"center",width:300},
        ...
        table.on('tool(lay_table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){
                toEdit(data.order_id,0)
            }  else if(layEvent === 'edit'){
                toEdit(data.order_id,1)
            }else if(layEvent === 'drive'){
                toDrive(data.order_id)
            }else if(layEvent === 'del'){
                layer.confirm('确认删除么', function(index){
                    layer.close(index);
                    obj.del(); //删除对应行（tr）的DOM结构
                    //向服务端发送删除指令
                    doDelete(data.order_id);
                });
            }
        });
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "order/toEdit.do?order_id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
    ...
    function toDrive(id){
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "order/trans.do?order_id="+id,
            area: ['1200px', '80%']
        })
    }
</script>
