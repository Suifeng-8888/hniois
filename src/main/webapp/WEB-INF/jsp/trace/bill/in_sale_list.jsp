    ...
    <form action="Buy/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <a id="hniois-export" onclick="doExport('order/doExport?msg=1')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            elem: '#table',
            url:'order/inSaleList.do',
            limits:[10],
            cols: [[
                {type:'checkbox'},
               // {field:'id',  title: '序号'},
                {field:'sale_name',  title: '销售商'},
                {field:'cost',  title: '销售额(¥)'}
    ...
    function initChart11(d){
        ...
        for(var i=0;i<d.data.length;i++){
            ...
            dataName.push(d.data[i].sale_name);
        }
        var  option = {
            title : {
                text: '最近半年销售商采购额',
    ...
    function initChart22(d){
        ...
        for (var i = 0; i < obj.length; i++) {
            arrNum.push({"value": objNum[i].cost,"name":obj[i].sale_name});
        }
        var  option = {
            title : {
                text: '供应商采购额对比',
