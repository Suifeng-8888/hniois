        ...
        <div class="hniois-table-header">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="crop" placeholder="搜索产品名.." />
...
<script type="text/html" id="editBar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="fill">包装详情</a>
    </c:if>
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
              //  {field:'batch_id',  title:'包装ID',align:"center"},
              //  {field:'farm_id',  title:'农场ID',align:"center"},
              //  {field:'crop_id',  title:'产品ID',align:"center"},
                {field:'crop', title: '产品名称',align:"center",width:120},
                {field:'batch', title: '包装批次',align:"center",width:220},
                {field:'btime', title: '包装时间',align:"center",width:150},
                {field:'weight', title: '净含量',align:"center",width:120},
                {field:'quality_time', title: '保质期',align:"center",width:150},
                {field:'person', title: '包装负责人',align:"center",width:120},
                {field:'storage', title: '存储条件',align:"center",width:200},
                {field:'bat_img', title: '包装图片',align:"center",width:120,templet:function(d){
                        //学校多张图片，默认显示第一张
                ...
                {fixed: 'right', align:'center',width: 250,toolbar: '#editBar'}
            ]],
