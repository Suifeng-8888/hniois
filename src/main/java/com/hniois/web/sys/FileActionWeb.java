...
public class FileActionWeb extends BaseController {
    /**
     *文件上传
     * @param request
    ...
    @ResponseBody
    public String delete(HttpServletRequest request, HttpServletResponse response,String path){
        response.setContentType("text/html; charset=UTF-8");
        JSONObject r = JSONObject.fromObject("{\"state\":\"err\",\"message\":\"删除失败\"}");
        //文件保存目录路径
        //文件保存目录路径
