...
public class Register extends Page {
    ...
    private String p_certificate; // 待用
    ...
    private String state;//0 待审批 1初审通过 2初审驳回 3审核通过 4复审驳回
    private String apo_reason;//驳回理由(审批通过则忽略测属性)
    private String aly_time;//申请日期
    private String apo_time;//审批时间
    ...
    public String getApo_reason() {
        return apo_reason;
    }

    public void setApo_reason(String apo_reason) {
        this.apo_reason = apo_reason;
    }

    public String getAly_time() {
        return aly_time;
    }

    public void setAly_time(String aly_time) {
        this.aly_time = aly_time;
    }
    ...
    public void setApo_time(String apo_time) {
        this.apo_time = apo_time;
    }
