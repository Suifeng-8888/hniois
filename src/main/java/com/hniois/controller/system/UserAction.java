...
public class UserAction extends BaseController{
    ...
    private String edit = "system/user/edit";
    private String user_change = "system/user/user_change";
    private String user_img = "system/user/user_img";
    private String outfit_table = "system/user/outfit_table";
    private String farm_table = "system/user/farm_table";
    ...
    public ModelAndView toAorU(User e) throws Exception{
        ...
        List<Providers> plist = providersService.findList(new Providers());
    ...
    public ModelAndView edit(User e) throws Exception{
        ModelAndView mv = this.getModelAndView();
        User user = new User();
        if(StringUtils.isNotEmpty(e.getId())){
            user = userService.find(e);
    ...
    public ModelAndView chose(User e){
        ModelAndView mv=getModelAndView();
        //监管机构
        if(Const.OUTFIT_ADMIN.equals(e.getBz())) {
            mv.setViewName(outfit_table);
        //生产基地
        }else if(Const.PROVIDER_ADMIN.equals(e.getBz())) {
            mv.setViewName(farm_table);
        }
        // TODO: 2018/12/19  判断  欠缺
